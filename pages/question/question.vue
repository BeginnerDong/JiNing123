<template>
	<view style="width:100%;height: 100%;background: #F2F2F2;">
		<!-- search部分 -->
...
<style scoped>
	...
	/* nav部分 */
	.nav{font-size: 28rpx;width: 100%;background: #FFFFFF;border: solid 1px #EFEFEF;height: 100rpx;}
	.nav>li{-webkit-flex: 1;text-align: center;color: #666666;}
